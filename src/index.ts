...
let $formsEliminarTarea: any = document.querySelectorAll('.delet-form');
...
$formAgregarTarea.addEventListener('submit', (event: Event) => {
    ...
    $formsEliminarTarea = document.querySelectorAll('.delet-form');
});

// Eliminar tarea
function eventoEliminar(id: string) {
